...
do
  ...
  do
    ...
    echo ${fieldmap_orig}
    topup_jpos=${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_dir-PA_run-01_epi.nii.gz
    topup_jneg=${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_dir-AP_run-01_epi.nii.gz
    ...
    if [ -e ${topup_jpos} ]; then
      ...
      mv ${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_run-01_epi.json ${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_dir-PA_epi.json #rename the TOPUP json
      ...
      cp ${BIDS_dir}/${sub}/${ses}/dwi/${sub}_${ses}_run-01_dwi.json ${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_dir-AP_epi.json #copy the dwi json
      if [ ! -w "${BIDS_dir}/${sub}/${ses}/fmap/${sub}_${ses}_dir-PA_epi.json" ] #if file is not writable then
      then
