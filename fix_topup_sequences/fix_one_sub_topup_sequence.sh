...
mv fmap/${sub}_${ses}_run-01_epi.json fmap/${sub}_${ses}_acq-dwi_dir-PA_run-01_epi.json #rename the TOPUP json
...
cp dwi/${sub}_${ses}_run-01_dwi.json fmap/${sub}_${ses}_acq-dwi_dir-AP_run-01_epi.json #copy the dwi json
