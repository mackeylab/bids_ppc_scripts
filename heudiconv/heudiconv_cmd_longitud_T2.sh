...
singularity run -B ${SBIA_TMPDIR}:/tmp --cleanenv /cbica/projects/cbpd_main_data/tools/singularity/heudiconv0.5.4.simg -d /cbica/projects/cbpd_main_data/dicoms/{subject}_2/*.dcm -o ${dir} -f /cbica/projects/cbpd_main_data/CBPD/bids_ppc_scripts/heudiconv/heuristic.py -s ${subID} --ses 02 -c dcm2niix -b --minmeta;
